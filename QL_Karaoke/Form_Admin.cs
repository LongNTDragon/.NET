    ...
    public partial class Form_Admin : Form
    {
        ...
        private void btn_ThemNV_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                qlAD.insertNV(txtMaNV_AD.Text, txtTenNV_AD.Text, txt_NgaySinh_NV.Text, gioitinh, txtDiaChi_AD.Text, txtUserName_AD.Text, txtPassWord_AD.Text, combo_ChucVu.SelectedItem.ToString(), combo_Quyen_AD.SelectedItem.ToString(), txt_SoDienThoai.Text);
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    if (txtMaNV_AD.Text == dt.Rows[i][0].ToString())
                    {
                        ...
                        if (radioButtonNam_AD.Checked == true)
                            ...
                            gioitinh = radioButtonNu_AD.Text;
                        qlAD.updateNV(txtMaNV_AD.Text, txtTenNV_AD.Text, txt_NgaySinh_NV.Text, gioitinh, txtDiaChi_AD.Text, txtUserName_AD.Text, txtPassWord_AD.Text, combo_Quyen_AD.SelectedItem.ToString(), combo_ChucVu.SelectedItem.ToString(), txt_SoDienThoai.Text);
                        MessageBox.Show("Sửa thành công!");
                        loadListNhanVien();
                        break;
                    }
